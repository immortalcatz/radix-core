...
public interface ILanguageLoaderHook 
{
	 ...
	 * 
	 * For example, MCA uses this to populate two different lists with male and female names
	 * so that one can be randomly generated properly.
	 * 
	...
	/**
	 * Called when the language loader gets a request for a string and you return
	 * <b>true</b> on <code>shouldReceiveGetStringCalls();</code>
	 * <p>
	 * For example, MCA uses this to properly implement its random dialogue system.
	 * Smaller mods with only items and GUI buttons to translate will most likely
	 * have no benefit to processing a getString request themselves.
	 * 
